...
<div id="tooltip-default" role="tooltip"
    class="absolute z-10 invisible inline-block px-3 py-2 text-sm font-medium text-white transition-opacity duration-300 bg-stone-800 rounded-lg shadow-xs opacity-0 tooltip">
    Back to gate
