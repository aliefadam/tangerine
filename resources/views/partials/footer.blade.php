<footer
    class="px-4 sm:px-6 lg:px-12 py-16 {{ request()->routeIs('classes') || request()->routeIs('member.checkout') || request()->routeIs('payment.waiting') || request()->routeIs('class.detail') || request()->routeIs('profile') ? 'bg-stone-100' : 'bg-white' }}">
