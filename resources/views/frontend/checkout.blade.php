        ...
        <div class="mt-10 sm:w-full lg:w-1/2 mx-auto space-y-5 pb-20 py-10 px-5">
            ...
            <div class="w-full lg:w-1/2 mx-auto">
                ...
                <div class="mt-12 flex flex-col gap-5">
                    <div class="">
                        <label for="notes" class="block mb-3 text-sm font-medium text-gray-900 dark:text-white">
                            ...
                            @foreach ($calendarData[$year] as $month => $data)
                                <div class="mb-8 p-5 border rounded-lg shadow-md bg-white">
                                    <h3 class="text-xl font-semibold text-center mb-2">{{ $month }}
                                        {{ $year }}</h3>
                                    <div
                                        class="grid grid-cols-7 text-sm text-center poppinsmedium bg-stone-700 text-white py-2.5 mt-3">
                                        <div>Sunday</div>
                                        <div>Monday</div>
                                        <div>Tuesday</div>
                                        <div>Wednesday</div>
